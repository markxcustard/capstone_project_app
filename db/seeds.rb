...
Exercise.create(name: "DB Snatch", olympic_weightlifting: false, description: "The single-arm dumbbell snatch increases power and strength throughout the body with an emphasis on the shoulders and back. This exercise also improves coordination, core strength, and serves as a stepping stone to the clean and jerk snatch.", video_link: "https://www.youtube.com/watch?v=R0mhHuVrLHA")
Exercise.create(name: "Double Unders", olympic_weightlifting: false, description: "A double under is a popular exercise done on a jump rope in which the rope makes two passes per jump instead of just one. It is significantly more effective than a single rope pass in that it allows for higher work capacity. ", video_link: "https://www.youtube.com/watch?v=-tF3hUsPZAI")
...
Exercise.create(name: "Deadlift", olympic_weightlifting: false, description: "The deadlift is a weight training exercise in which a loaded barbell or bar is lifted off the ground to the level of the hips, then lowered to the ground. It is one of the three powerlifting exercises, along with the squat and bench press.", video_link: "https://www.youtube.com/watch?v=op9kVnSso6Q")
Exercise.create(name: "Snatch", olympic_weightlifting: false, description: "The Snatch is the world's fastest lift. In addition to moving the weight quickly, the snatch also moves the weight a long distance - from the ground all the way overhead. The snatch not only trains power, but is an excellent developer of balance, flexibility, coordination, speed and strength.", video_link: "https://www.youtube.com/watch?v=9xQp2sldyts")
Exercise.create(name: "Row", olympic_weightlifting: false, description: "Rowing is a very natural motion and most people pick it up quickly. A row is divided into 4 components, the catch, the drive, the finish and the recovery", video_link: "https://www.youtube.com/watch?v=S7HEm-fd534")
