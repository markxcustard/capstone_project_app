...
Exercise.create(name: "Front Plank", olympic_weightlifting: false, description: "The plank (also called a front hold, hover, or abdominal bridge) is an isometric core strength exercise that involves maintaining a position similar to a push-up for the maximum possible time.", video_link: "https://www.youtube.com/embed/LS43rF4X9J0")
Exercise.create(name: "Russian Twist", olympic_weightlifting: false, description: "Lean back and take the feet off the floor so you are balancing on the buttocks. Hold a medicine ball in both hands in front of you with the elbows slightly bent. Twist from side to side, ensuring you are moving from your waist, not your shoulders! This exercise is sometimes also known as a russian twist.", video_link: "https://www.youtube.com/embed/4wNNCQj2mV4")
Exercise.create(name: "Chest Fly", olympic_weightlifting: false, description: "The chest fly is a great exercise for toning and strengthening the pectoral muscles, as well as the triceps and shoulders. This exercise adds definition to these muscles, and increases the metabolic rate of the body due to an increase in the amount of muscle mass that it provides", video_link: "https://www.youtube.com/embed/tJ2kaO29NDM")
Exercise.create(name: "Bent Over Row", olympic_weightlifting: false, description: "Assume a standing position while holding the bar using a double overhand grip. Hinge forward until your torso is roughly parallel with the floor (or slightly above) and then begin the movement by driving the elbows behind the body while retracting the shoulder blades", video_link: "https://www.youtube.com/embed/TeUzJmU25Rc")
...
Workout.create(name: "AMRAP", description: "AMRAP is defined as an abbreviation that means as many reps as possible, meaning to do a circuit of exercises as many times as possible within a specific period of time.",  duration_workout: 0, duration_rest: 0, duration_total: 600, reps: 0, rounds: 0, distance: 0)
